...
class Item
    ...
    setElem: (elem) ->
        ...
        for i in [0...points.length]
            ...
            @editCtrl 'append', 'point', i, @trans.transform(@elem, p), point
            ...
            switch @elem.type
                ...
                when 'polygon', 'polyline', 'line' then
                    ...
                    switch point[0]
                        when 'C', 'c', 'S', 's', 'Q', 'q'
                            @editCtrl 'append', 'ctrl1', i, @trans.transform(@elem, pos point[1], point[2]), point

                    switch point[0]
                        when 'S', 's'
                            @editCtrl 'append', 'ctrlr', i, @trans.transform(@elem, pos point[1], point[2]), point
                        when 'C', 'c'
                            @editCtrl 'append', 'ctrl2', i, @trans.transform(@elem, pos point[3], point[4]), point
    ...
    editCtrl: (action, type, index, p, point) =>
